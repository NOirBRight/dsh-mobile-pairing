...
export function apply(ctx, config) {
    ...
    function tunnelOptions(room) { return { upstreamHost: resolved.dshHost, upstreamPort: resolved.dshPort, handshake: { keypair, offers, devices: store, room, hostName: displayName }, logger: (message) => ctx.logger.info('dsh-mobile-pairing: ' + message) }; }
